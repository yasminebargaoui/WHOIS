...
app.use(express.static(path.join(__dirname, './userDetection.html')));
//proxy
// Add headers
...
html {font-family: Helvetica;
    ...
    *, :after, :before {
    ...
    align-items: center;
        ...
        margin: 0;
        padding: 0;
        background: center url("/306746634_386224643710024_5480548491986611774_n.jpg") no-repeat;
...
<div class="container">
    ...
    <h1>Bee | Fournisseur d'accés Internet</h1>
        ...
        <h4> Veuillez entrer les informations soigneusement </h4>
    <form action="/radacct" method="post" id="detection ">
        
    <div class="form-group" >
        <label for="IpAdress">Adresse IP  </label>
        <input 
     ...
     <br>
    <div class="form-group">
                <label for="cnxDate" required >Données de connexion   </label>
        <input 
...
<div class="container">
  ...
  <div class="container mt-5">
      ...
      <button class="top-left-button" onclick="history.back();">&#8678;		Retour</button>
</br>
</br>
